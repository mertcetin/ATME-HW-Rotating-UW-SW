...
quietly virtual signal -install /test3DRS/DUT/swaddrgen { /test3DRS/DUT/swaddrgen/vecin1[13:7]} vecin1_y
quietly virtual signal -install /test3DRS/DUT/swaddrgen { /test3DRS/DUT/swaddrgen/vecin1[6:0]} vecin1_x
quietly virtual signal -install /test3DRS/DUT/swaddrgen { /test3DRS/DUT/swaddrgen/vecin2[13:7]} vecin2_y
quietly virtual signal -install /test3DRS/DUT/swaddrgen { /test3DRS/DUT/swaddrgen/vecin2[6:0]} vecin2_x
quietly virtual signal -install /test3DRS/DUT/swaddrgen { /test3DRS/DUT/swaddrgen/vecin3[13:7]} vecin3_y
quietly virtual signal -install /test3DRS/DUT/swaddrgen { /test3DRS/DUT/swaddrgen/vecin3[6:0]} vecin3_x
...
add wave -noupdate -format Literal -radix decimal /test3DRS/DUT/swaddrgen/vecin1_y
add wave -noupdate -format Literal -radix decimal /test3DRS/DUT/swaddrgen/vecin1_x
add wave -noupdate -format Literal -radix decimal /test3DRS/DUT/swaddrgen/vecin2_y
add wave -noupdate -format Literal -radix decimal /test3DRS/DUT/swaddrgen/vecin2_x
add wave -noupdate -format Literal -radix decimal /test3DRS/DUT/swaddrgen/vecin3_y
add wave -noupdate -format Literal -radix decimal /test3DRS/DUT/swaddrgen/vecin3_x
...
add wave -noupdate -format Logic /test3DRS/DUT/swaddrgen/inside
add wave -noupdate -format Logic /test3DRS/DUT/swaddrgen/within_reach
add wave -noupdate -format Logic /test3DRS/DUT/swaddrgen/inside_row
add wave -noupdate -format Logic /test3DRS/DUT/swaddrgen/inside_col
...
add wave -noupdate -format Literal -radix unsigned /test3DRS/DUT/swaddrgen/act_howmany_row
add wave -noupdate -format Literal -radix unsigned /test3DRS/DUT/swaddrgen/act_howmany_col
add wave -noupdate -format Logic /test3DRS/DUT/swaddrgen/sign_howmany_row
add wave -noupdate -format Logic /test3DRS/DUT/swaddrgen/sign_howmany_col
add wave -noupdate -format Literal -radix decimal /test3DRS/DUT/swaddrgen/howmany_row_signed
add wave -noupdate -format Literal -radix decimal /test3DRS/DUT/swaddrgen/act_howmany_row_signed
add wave -noupdate -format Literal -radix decimal /test3DRS/DUT/swaddrgen/howmany_col_signed
add wave -noupdate -format Literal -radix decimal /test3DRS/DUT/swaddrgen/act_howmany_col_signed
add wave -noupdate -format Literal -radix unsigned /test3DRS/DUT/swaddrgen/withincheck
add wave -noupdate -format Literal -radix decimal /test3DRS/DUT/swaddrgen/UWcount_col_value
add wave -noupdate -format Literal -radix decimal /test3DRS/DUT/swaddrgen/UWcount_row_value
add wave -noupdate -format Literal -radix decimal /test3DRS/DUT/swaddrgen/limited_out_x
add wave -noupdate -format Literal -radix decimal /test3DRS/DUT/swaddrgen/limited_out_y
...
add wave -noupdate -format Literal -radix decimal /test3DRS/DUT/swaddrgen/whichblock_x
...
add wave -noupdate -format Literal -radix unsigned /test3DRS/DUT/swaddrgen/SWcoord_x_reg
add wave -noupdate -format Literal -radix unsigned /test3DRS/DUT/swaddrgen/SWcoord_y_reg
add wave -noupdate -format Literal -radix unsigned /test3DRS/DUT/swaddrgen/preSWcoord_x
add wave -noupdate -format Literal -radix unsigned /test3DRS/DUT/swaddrgen/preSWcoord_y
add wave -noupdate -format Literal /test3DRS/DUT/swaddrgen/addrrow
add wave -noupdate -format Literal -radix unsigned /test3DRS/DUT/swaddrgen/addrcol
add wave -noupdate -format Literal -radix unsigned /test3DRS/DUT/swaddrgen/addrcol2
...
add wave -noupdate -format Literal -radix unsigned /test3DRS/DUT/swaddrgen/addrcol13
...
add wave -noupdate -format Literal -radix decimal /test3DRS/DUT/swaddrgen/pre_new_ref_x
add wave -noupdate -format Literal -radix decimal /test3DRS/DUT/swaddrgen/pre_new_ref_y
...
add wave -noupdate -format Literal -radix decimal /test3DRS/DUT/swaddrgen/ref_x_minusone
add wave -noupdate -format Literal -radix decimal /test3DRS/DUT/swaddrgen/ref_y_minusone
add wave -noupdate -format Literal -radix unsigned /test3DRS/DUT/swaddrgen/mod_ref_x_minusone
add wave -noupdate -format Literal -radix unsigned /test3DRS/DUT/swaddrgen/mod_ref_y_minusone
add wave -noupdate -format Literal -radix unsigned /test3DRS/DUT/swaddrgen/start_block_x
add wave -noupdate -format Literal -radix unsigned /test3DRS/DUT/swaddrgen/start_block_y
...
WaveRestoreCursors {{Cursor 1} {92130278 ps} 0}
...
update
WaveRestoreZoom {35002810041 ps} {35004127893 ps}
